						...
						<div class="leave-comment" style="background-color: black;">
							       <div class="row">
							        	<div class="col-md-6">
								            ...
								            <div style="border: dashed; width: 75px; height: 3px; margin: 2px 0 20px; border-color: orange;">
								            </div>
								   ...
								   <div class="col-md-6">
								            ...
								            <div style="border: dashed; width: 125px; height: 3px; margin: 2px 0 20px; border-color: orange;">
								            </div>
								   ...
								   <div class="row">
								      	<div class="col-md-9">
								            <h4 style="font-weight: bold; color: white;">CALL US</h4>
								            <div style="border: dashed; width: 70px; height: 3px; margin: 2px 0 20px; border-color: orange;">
								            </div>
								   ...
								   <div class="row">
								        <div class="col-md-9">
								            <h4 style="font-weight: bold; color: white;">EMAIL US</h4>
								            <div style="border: dashed; width: 80px; height: 3px; margin: 2px 0 20px; border-color: orange;">
								         	</div>
