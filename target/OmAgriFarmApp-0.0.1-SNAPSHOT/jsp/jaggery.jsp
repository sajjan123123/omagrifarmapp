			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singlejaggery.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							<h4>Jaggery</h4>
							<p class="price">$380</p>
							<p>&emsp;Jaggery is a traditional non-centrifugal cane sugar consumed in some countries in Asia and the Americas.
							It is a concentrated product of cane juice and often date or palm sap (see: palm sugar) without separation of the molasses and crystals, and can vary from golden brown to dark brown in colour.
							It contains up to 50% sucrose, up to 20% invert sugars, and up to 20% moisture, with the remainder made up of other insoluble matter, such as wood ash, proteins, and bagasse fibres.</p>
