			...
			<div class="row">
				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
						...
						<li class="active">Mango Papad</li>
					</ol>
				</div> <!-- /.col-md-8 -->
			</div>	<!-- /.row -->
		</div>	<!-- /.container-->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singlepapad.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							<h4>Mango Papad</h4>
							<p class="price">$380</p>
							<p>&emsp;Mango papad is an Indian fruit leather made out of mango pulp mixed with concentrated sugar solution and sun dried. It is also known as aamba sadhaa (Odia), Aamta (Assamese), amawat (Hindi), Managa Thera (Malayalam), mamidi tandra (Telugu), aamsotto (Bengali) and amba vadi (Marathi).<br><br>
								&emsp;Traditional Aam Papad is sweet, although it is available in different varieties. It can be preserved for months making it popular in the off season of mangoes.<br><br>
								&emsp;Aam Papad can be consumed in any season as it can be preserved for a long period of time.</p>
