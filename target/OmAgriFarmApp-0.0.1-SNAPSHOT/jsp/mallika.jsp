				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
						...
						<li><a href="#">Mango</a></li>
					  	<li class="active">Mallika Mango</li>
					</ol>
				</div> <!-- /.col-md-8 -->
			</div>	<!-- /.row -->
		</div>	<!-- /.container-->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singlemallika.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							<h4>Mallika Mango</h4>
							<p class="price">$380</p>
							<p>&emsp;The 'Mallika' mango is the result of the hybridization of the Indian mango varieties Neelum and Dasheri.
								The variety was introduced by Dr. Ramnath Singh. When grafted, the tree will remain a manageable size and is appropriate for dooryard growing. 
								Fruit is normally ready to harvest from June to July.<br><br>
								&emsp;Mallika produces high quality, fiberless orange fruit. The fruit has prominent citrus, melon and honey notes and is exceptionally sweet. 
								The cultivar met a positive reception at the Fairchild Botanic Gardens International Mango Festival.</p>
