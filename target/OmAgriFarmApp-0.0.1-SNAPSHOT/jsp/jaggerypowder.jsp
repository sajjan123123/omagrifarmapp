				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
						...
						<li><a href="#">Jaggery</a></li>
					  	<li class="active">Jaggery Powder</li>
					</ol>
				</div> <!-- /.col-md-8 -->
			</div>	<!-- /.row -->
		</div>	<!-- /.container-->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singlepowder.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							...
							<p class="price">$380</p>
							<p>&emsp;Jaggery is a sweetener made from sugar cane that's becoming popular as a "healthy" replacement for sugar. The Jaggery Powder is totally organic and is free from any type of pesticide, or chemical fertilizer or genetically developed crop.</p>
