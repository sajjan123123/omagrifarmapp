			...
			<div class="row">
				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
						...
						<li class="active">Kesar Mango</li>
					</ol>
				</div> <!-- /.col-md-8 -->
			</div>	<!-- /.row -->
		</div>	<!-- /.container-->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singlekesar.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							<h4>Kesar Mango</h4>
							<p class="price">$380</p>
							<p>&emsp;The 'Gir Kesar' mango, also called Kesar, is a mango cultivar grown in the foothills of Girnar in Gujarat, western India. 
							The mango is known for its bright orange colored pulp and was given the geographical indication status in 2011.<br><br>
							&emsp;The mango was first grown in 1931 by Junagadh Wazir Sale Bhai in Vanthali. About 75 grafts were then planted in the foothills of Girnar at the Junagadh Laal Dori farm. 
							The mango is said to have been known as "Kesar" since 1934 when the Nawab of Junagadh Muhammad Mahabat Khan III said "This is Kesar" looking at the orange pulp of the fruit—kesar being Hindi for saffron.</p>
