			...
			<div class="row">
				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
						...
						<li class="active">Alphonso Mango</li>
					</ol>
				</div> <!-- /.col-md-8 -->
			</div>	<!-- /.row -->
		</div>	<!-- /.container-->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singlemango.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							...
							<p class="price">$380</p>
							<p>&emsp;The 'Alphonso' mango, also called 'King of Mangoes', Badami, Hafoos, Hapuz, or Aapoos, is a named mango cultivar that originated in India.
							Favored for its sweetness, richness and flavor, the Alphonso has been called the king of mangoes.<br><br>
							&emsp;The variety is named after Afonso de Albuquerque, a Portuguese general and military expert who helped establish Portuguese colonies in India.
							The Portuguese introduced grafting on mango trees to produce varieties like Alphonso. 
							The Alphonso is also one of the most expensive varieties of mango, and is grown mainly in western India.<br><br>
							&emsp;The Alphonso is a seasonal fruit, available mid-April through the end of June.
							The fruits generally weigh between 150 and 300 grams (5.3 and 10.6 oz).
							They have a rich, creamy, tender texture and delicate, non-fibrous, juicy pulp.
							...
							The flesh of the fruit is saffron-colored.
							These characteristics make Alphonso a favored cultivar.</p>
