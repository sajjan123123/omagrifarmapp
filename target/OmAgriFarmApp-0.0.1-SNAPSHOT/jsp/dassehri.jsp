				...
				<div class="col-md-8 hidden-xs">
					<ol class="breadcrumb pull-right">
						...
						<li><a href="#">Mango</a></li>
					  	<li class="active">Dassehri Mango</li>
					</ol>
				</div> <!-- /.col-md-8 -->
			</div>	<!-- /.row -->
		</div>	<!-- /.container-->
			...
			<div class="row">
				<div class="col-md-5">
					<div class="single-product-img">
						<img src="images/singledassehri.jpg" alt="not">
					</div>
				...
				<div class="col-md-4">
					<div class="block">
						<div class="product-des">
							...
							<p class="price">$380</p>
							<p>&emsp;The 'Dasheri' mango is a mango cultivar which originated in a village near Kakori in Lucknow district in 18th century.
							It is a sweet and fragrant variety of mango grown in North India and the southern state Andhra Pradesh, Nepal and Pakistan.
							Malihabad in Uttar Pradesh is the largest producer of the Dasheri mango.<br><br>
							&emsp;In the 18th century, Dasheri first appeared in the gardens of Nawab of Lucknow.
							Since then Dasheri plants have been produced and planted throughout India.
							People from the village Dasheri near Kakori, Uttar Pradesh have the mother plant.
							This mother plant belonged to the orchards of Late Mohammad Ansar Zaidi.
							This mother plant is said to be around 200 years old.
							It bears fruit every alternate year.
							Though the fruit is small when compared to its grafted counterparts, its flavor and aroma are unmatched.
							The plant is being well taken care of by Mr. Zaidi's descendants. It is often referred to as "The Mother Dasehri".<br><br>
							&emsp;The Dasheri mango is exported internationally to various countries including Singapore, Hong Kong, The Philippines, Malaysia, and other countries in South-East Asia.</p>
